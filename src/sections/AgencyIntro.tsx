        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            <div className="inline-flex items-center gap-2 px-3 py-1 bg-[#141414] border border-[#2A2A2A] rounded-full mb-6 animate-item">
              ...
              <span className="font-mono text-[10px] text-[#C9A96E] tracking-widest uppercase">Inside Vantility</span>
            </div>
            
            <h2 className="section-title text-[#F5F0EB] mb-8 animate-item">
              AI Infrastructure for Modern Real Estate
            </h2>
            <div className="space-y-6 animate-item">
              <p className="font-body text-base text-[#F5F0EB] leading-relaxed">
                Vantility is a specialised AI agency building practical digital workforces for real estate companies. We combine AI agents, business automations, premium websites, communication systems, reporting tools, and human approval controls into a single coordinated infrastructure.
              </p>
              <p className="font-body text-base text-[#8A8478] leading-relaxed">
                We do not add AI for decoration. We design it around the way your business actually works. Every client system is tailored to their unique projects, buyers, lead sources, sales processes, and reporting requirements.
              </p>
            </div>
          </div>
          ...
          <div className="bg-[#141414] border border-[#2A2A2A] rounded-2xl p-8 lg:p-10 animate-item shadow-2xl shadow-black/50 hover:border-[#C9A96E]/30 transition-colors duration-500">
            ...
            <div className="mt-12 pt-8 border-t border-[#2A2A2A] flex items-center justify-between">
              <p className="font-mono text-[10px] uppercase tracking-[0.2em] text-[#5A5550]">
                VANTILITY AGENCY INFRASTRUCTURE
              </p>
            </div>
          </div>
        </div>
