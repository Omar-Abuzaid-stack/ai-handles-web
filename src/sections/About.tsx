        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <div className="space-y-6 animate-item">
              <p className="font-body text-base text-[#F5F0EB] leading-relaxed">
                Vantility is an AI agency building practical digital workforces for ambitious real estate companies. Our solutions connect communication, lead management, CRM, research, reporting, and automation into one coordinated system.
              </p>
              <p className="font-body text-base text-[#8A8478] leading-relaxed">
                We believe the future of real estate isn't just about having the best AI tools, but having the best AI infrastructure. We combine AI strategy, agent design, automation architecture, and business workflow mapping to create a technical foundation that actually supports growth without proportional administrative bloat.
              </p>
            </div>
          </div>
          <div className="bg-[#0A0A0A] border border-[#2A2A2A] rounded-2xl p-8 lg:p-12 animate-item">
            <h3 className="font-display text-2xl text-[#F5F0EB] mb-6 italic">
              "We don't replace your sales team. We give them a team of digital workers to handle everything else."
            </h3>
            <p className="font-body text-sm text-[#8A8478] uppercase tracking-widest">
              — Vantility Leadership
            </p>
          </div>
        </div>
      </div>
