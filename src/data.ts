...
export const timeline: TimelinePhase[] = [
  {
    ...
    title: 'Discovery',
    icon: 'Search',
    tasks: ['Understand business goals', 'Review current lead sources', 'Analyze sales process', 'Identify team requirements'],
  },
  {
    step: '02',
    title: 'Workflow Mapping',
    icon: 'Map',
    tasks: ['Map current lead journey', 'Identify manual delays', 'Define approval requirements', 'Map data movement'],
  },
  {
    step: '03',
    title: 'System Design',
    icon: 'Layout',
    tasks: ['Select AI agents', 'Design automation workflows', 'Plan custom interfaces', 'Define reporting structure'],
  },
  {
    step: '04',
    title: 'Agent and Automation Build',
    icon: 'Bot',
    tasks: ['Develop specialized agents', 'Setup automation sequences', 'Configure safety controls', 'Implement data handling'],
  },
  {
    step: '05',
    title: 'Integration',
    icon: 'Link',
    tasks: ['Connect CRM', 'Integrate WhatsApp/Email', 'Sync calendars', 'Connect required third-party APIs'],
  },
  {
    step: '06',
    title: 'Testing',
    icon: 'ShieldCheck',
    tasks: ['Simulate data movement', 'Test agent capabilities', 'Verify safety boundaries', 'Ensure smooth handover'],
  },
  {
    step: '07',
    title: 'Launch',
    icon: 'Rocket',
    tasks: ['Deploy to production', 'Train human managers', 'Establish approval workflows', 'Set operating modes'],
  },
  {
    step: '08',
    title: 'Ongoing Support',
    icon: 'TrendingUp',
    tasks: ['Monitor performance', 'Review activity logs', 'Expand capabilities', 'Refine workflows'],
  },
];
...
export const services: Service[] = [
  {
    ...
    description: 'Specialised digital workers designed for clear business responsibilities, including research, sales, and content.',
    features: [
    ...
    businessBenefit: 'Scale your team\'s output without increasing headcount.',
  ...
  },
  {
    ...
    description: 'Structured workflows that move information, trigger actions, schedule follow-ups, and update CRM systems automatically.',
    features: [
    ...
    businessBenefit: 'Eliminate manual data entry and repetitive administrative tasks.',
  ...
  },
  {
    ...
    description: 'Deploy AI into your existing systems including CRM, WhatsApp, email, websites, calendars, and custom APIs.',
    features: [
      'CRM integration',
      'WhatsApp API setup',
      'Email & Calendar sync',
    ...
    businessBenefit: 'Connect disconnected tools into a single, unified operational engine.',
    link: '/services/ai-deployment',
  },
  {
    id: 'websites',
    icon: 'Layout',
    ...
    description: 'Build premium websites equipped with AI chatbots, lead capture forms, automations, and CRM integrations.',
    features: [
    ...
    businessBenefit: 'Turn your website from a static brochure into an active lead-generation machine.',
  ...
  },
  {
    ...
    description: 'Paid ads generate attention. We build the infrastructure to capture, organise, and convert that attention.',
    features: [
      'Paid-ad strategy',
    ...
    businessBenefit: 'Maximise ROI on ad spend with flawless, automated lead follow-up.',
  ...
  },
  {
    ...
    description: 'Professional AI voice agents to handle inbound enquiries, qualify leads, and perform outbound outreach calls.',
    features: [
