...
export default function AIDeploymentPage() {
  ...
  const features = [
    { title: 'Secure Infrastructure', description: 'Enterprise-grade security protecting your data and your AI models.', icon: <Shield size={24} /> },
    { title: 'Scalable Architecture', description: 'Systems built to scale effortlessly as your usage and business grow.', icon: <Layers size={24} /> },
    { title: 'Local & Cloud Deployment', description: 'Flexible deployment options suited to your specific compliance and performance needs.', icon: <Server size={24} /> },
  ];
    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <section className="section-padding bg-[#070707]">
        <div className="content-max text-center">
          ...
          <h2 className="heading-section mb-6">Built for Performance</h2>
          <p className="body-text max-w-2xl mx-auto">
            From low-latency APIs to heavy batch processing, our deployments are optimized for cost and speed, ensuring reliable AI integration in your daily operations.
          </p>
        </div>
      </section>
    </div>
